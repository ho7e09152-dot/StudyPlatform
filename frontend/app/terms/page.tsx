  ...
  return (
    <LegalDocumentPage
      ...
      sections={[
        ...
        { title: "서비스의 역할", paragraphs: ["Study-ing은 사용자가 승인한 GitLab 프로젝트 또는 GitHub 저장소의 학습 일정과 제출 파일을 조회하고, 사용자의 해당 Provider 계정 권한으로 커밋을 생성하는 도구입니다."] },
        ...
        { title: "데이터와 삭제", paragraphs: ["일정과 제출 본문은 연결한 GitLab 또는 GitHub 저장소에 남습니다. Workspace 삭제는 서비스 DB에서 7일간 복원할 수 있으며, 만료 후 Workspace와 연결된 서비스 데이터가 정리되어도 감사 기록은 생성일부터 최대 180일, 저장소 파일과 commit은 각 Provider 정책에 따라 남을 수 있습니다."] },
        { title: "서비스 변경 및 중단", paragraphs: ["GitLab·GitHub 장애, 권한 변경 또는 유지보수로 일부 기능이 일시 중단될 수 있습니다. 중요한 변경은 서비스 화면에 알립니다."] },
      ]}
    />
  );
}
