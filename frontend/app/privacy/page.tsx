  ...
  return (
    <LegalDocumentPage
      ...
      sections={[
        ...
        { title: "수집·저장하는 정보", paragraphs: ["로그인하거나 연결한 GitLab·GitHub 계정의 사용자 ID, 사용자명, 표시 이름, 프로필 이미지 URL, 연결한 저장소 정보, Workspace 역할, 동기화·감사 로그와 알림을 저장합니다. OAuth access/refresh token은 서버 DB에 AES-GCM으로 암호화해 저장합니다. Provider email은 수집하지 않습니다."] },
        { title: "이용 목적", paragraphs: ["정보는 로그인, GitLab·GitHub API 요청, Workspace 접근 통제, 장애 복구와 보안 감사에만 사용합니다."] },
        ...
        { title: "연결한 저장소에 남는 정보", paragraphs: ["사용자가 커밋한 일정과 제출 파일 및 Git 이력은 GitLab 프로젝트 또는 GitHub 저장소에 남으며 Study-ing 계정 삭제로 제거되지 않습니다. 해당 정보는 저장소 관리자와 각 Provider 정책에 따라 관리됩니다."] },
