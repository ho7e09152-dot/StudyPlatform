...
const ERROR_COPY: Record<string, string> = {
  ...
  GITHUB_REAUTH_REQUIRED: "GitHub 계정을 다시 승인해주세요.",
  GITHUB_REPOSITORY_ACCESS_DENIED: "이 GitHub 저장소에 접근할 권한이 없습니다.",
  GITHUB_REPOSITORY_NOT_FOUND: "GitHub 저장소를 찾지 못했습니다.",
  GITHUB_RATE_LIMITED: "GitHub 요청 제한에 도달했습니다. 잠시 후 다시 시도해주세요.",
  REPOSITORY_ACCESS_REVOKED: "저장소 접근 권한을 확인해주세요.",
  REPOSITORY_PROVIDER_UNAVAILABLE: "저장소 연결 상태를 확인하지 못했습니다. 잠시 후 다시 시도해주세요.",
  PROVIDER_ACCOUNT_REQUIRED: "저장소 Provider 계정 연결을 다시 확인해주세요.",
  ...
  WORKSPACE_PROJECT_ALREADY_CONNECTED: "이미 다른 Workspace와 연결된 프로젝트입니다.",
	...
	WORKSPACE_JOIN_PERMISSION_REQUIRED: "Workspace 참여와 학습 제출을 위해 저장소 쓰기 권한이 필요합니다.",
	REPOSITORY_WRITE_PERMISSION_REQUIRED: "Workspace 연결과 학습 제출을 위해 저장소 쓰기 권한이 필요합니다.",
