...
| 점수 | 1차 제출 10P, 2차 제출 6P, 개인 점수 카드, 멤버 순위 그래프 |
...
초기 연결 검증에서는 서버 환경변수에 읽기 전용 Personal Access Token을 사용하고, 네트워크와 프로젝트 권한이 확인되면 정식 OAuth 방식으로 교체할 예정입니다. 토큰은 프론트엔드 코드나 Git 저장소에 포함하지 않습니다.
