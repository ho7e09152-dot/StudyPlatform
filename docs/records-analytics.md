# Records analytics definitions and QA

`/records` follows `docs/design-system.md` and treats Records as period analytics. Submission content, learning-item detail, reviews, and provider originals remain in Library.
...
- Before: `artifacts/records-redesign-before/`
- After: `artifacts/records-redesign-after/`
- Automated result: `artifacts/records-redesign-after/qa-results.json`
