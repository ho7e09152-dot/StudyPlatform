...
Current application migrations end at V12. V10 adds independent consent and retention indexes, V11 adds the multi-provider identity/repository foundation, and V12 adds GitHub account-link state support. Confirm the startup log reaches V12 before sending user traffic.
